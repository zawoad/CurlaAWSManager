 ...
 * @author zawoad
 */
public class ControllerConfiguration extends javax.swing.JDialog {

    /**
     * Creates new form S3SourceControlManager
     */
    public ControllerConfiguration() {
        setTitle("Manage System Configuration");
        initComponents();
    }
    public ControllerConfiguration(List<Object[]> analyzerList, JFrame parent) {
        super(parent, true);
        setTitle("Manage System Configuration");
        this.analyzerList = analyzerList;
        initComponents();
    }
    public ControllerConfiguration(String ip) {
        setTitle("Manage System Configuration");
        this.instanceIP = ip;
        initComponents();
    }
